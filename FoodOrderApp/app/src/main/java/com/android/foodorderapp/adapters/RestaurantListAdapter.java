...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, int position) {
        RestaurantModel restaurantModel = restaurantModelList.get(holder.getAdapterPosition());
        holder.restaurantName.setText(restaurantModel.getName());
        holder.restaurantAddress.setText("Адрес: " + restaurantModel.getAddress());
//        holder.restaurantHours.setText("Время работы: " + restaurantModel.getHours().getTodaysHours());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickListener.onItemClick(restaurantModel);
            }
        });
